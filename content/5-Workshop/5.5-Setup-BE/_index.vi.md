...
![Kiến trúc Backend](/aws-intern-report/images/5-Workshop/5.5-Setup-BE/be-architecture.png)
_(Hình ảnh: Luồng hoạt động tổng quan của Backend và các kết nối dữ liệu)_
