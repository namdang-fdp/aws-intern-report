...
![Redis Subnet Group](/aws-intern-report/images/5-Workshop/5.5-be/redis-subnet-group.png)
...
![Engine Selection](/aws-intern-report/images/5-Workshop/5.5-be/redis-1.png)
...
![Cluster Settings](/aws-intern-report/images/5-Workshop/5.5-be/redis-2.png)

6.  **Node configuration:**
    -   **Node type:** `cache.t3.micro` (Cost-effective for testing).
    -   **Number of replicas:** `0` (Standalone node for this workshop).

![Node Configuration](/aws-intern-report/images/5-Workshop/5.5-be/redis-3.png)

7.  **Connectivity:**
    -   **Network type:** `IPv4`.
    -   **Subnet groups:** Select `bandup-cached-subnet-group`.

![Connectivity Settings](/aws-intern-report/images/5-Workshop/5.5-be/redis-4.png)
...
![Security Settings](/aws-intern-report/images/5-Workshop/5.5-be/redis-5.png)
