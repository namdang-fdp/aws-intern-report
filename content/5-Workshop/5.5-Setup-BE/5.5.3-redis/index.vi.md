...
![Chọn Engine](/aws-intern-report/images/5-Workshop/5.5-be/redis-1.png)
...
![Cấu hình Cluster](/aws-intern-report/images/5-Workshop/5.5-be/redis-2.png)

6.  **Cấu hình Node:**
    -   **Node type:** `cache.t3.micro` (Tiết kiệm chi phí cho workshop).
    -   **Number of replicas:** `0` (Chạy node đơn lẻ).

![Cấu hình Node](/aws-intern-report/images/5-Workshop/5.5-be/redis-3.png)

7.  **Kết nối (Connectivity):**
    -   **Network type:** `IPv4`.
    -   **Subnet groups:** Chọn `bandup-cached-subnet-group`.

![Cấu hình Kết nối](/aws-intern-report/images/5-Workshop/5.5-be/redis-4.png)
...
![Cấu hình Bảo mật](/aws-intern-report/images/5-Workshop/5.5-be/redis-5.png)
