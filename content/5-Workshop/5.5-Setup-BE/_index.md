...
![Backend Architecture](/aws-intern-report/images/5-Workshop/5.5-Setup-BE/be-architecture.png)
_(Image: High-level flow of the Backend deployment and its connections)_
