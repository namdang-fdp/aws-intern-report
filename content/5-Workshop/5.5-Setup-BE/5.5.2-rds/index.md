...
![Backend Security Group](/aws-intern-report/images/5-Workshop/5.5-be/rds-sg-1.png)
...
![RDS Security Group](/aws-intern-report/images/5-Workshop/5.5-be/rds-sg-2.png)
...
![DB Subnet Group Created](/aws-intern-report/images/5-Workshop/5.5-be/rds-db-subnet-group.png)
...
![Select Engine](/aws-intern-report/images/5-Workshop/5.5-be/rds-1.png)
...
![Availability and Credentials](/aws-intern-report/images/5-Workshop/5.5-be/rds-2.png)
...
![Instance Size and Storage](/aws-intern-report/images/5-Workshop/5.5-be/rds-3.png)
...
![Connectivity Settings](/aws-intern-report/images/5-Workshop/5.5-be/rds-4.png)

9.  **Database authentication:** `Password authentication`.
10. **Monitoring:** Enable `Performance Insights` (retention 7 days).

![Authentication and Monitoring](/aws-intern-report/images/5-Workshop/5.5-be/rds-5.png)
...
![Additional Config](/aws-intern-report/images/5-Workshop/5.5-be/rds-7.png)
