...
![Tạo DB Subnet Group](/aws-intern-report/images/5-Workshop/5.5-be/rds-db-subnet-group.png)
...
![Chọn Engine](/aws-intern-report/images/5-Workshop/5.5-be/rds-1.png)
...
![Cấu hình Availability và Credential](/aws-intern-report/images/5-Workshop/5.5-be/rds-2.png)
...
![Cấu hình Instance và Storage](/aws-intern-report/images/5-Workshop/5.5-be/rds-3.png)
...
![Cấu hình Connectivity](/aws-intern-report/images/5-Workshop/5.5-be/rds-4.png)

9.  **Database authentication:** `Password authentication`.
10. **Monitoring:** Bật `Performance Insights` (lưu trữ 7 ngày).

![Xác thực và Giám sát](/aws-intern-report/images/5-Workshop/5.5-be/rds-5.png)
...
![Cấu hình bổ sung](/aws-intern-report/images/5-Workshop/5.5-be/rds-7.png)
