...
![Tạo Security Group cho ALB](/aws-intern-report/images/5-Workshop/5.3-Network/alb-sg.png)
...
![Cấu hình Target Group](/aws-intern-report/images/5-Workshop/5.3-Network/alb-target-group-1.png)

8.  **Register targets:** Vì chúng ta chưa triển khai ECS task nào, hãy bỏ qua bước này và nhấn **Create target group**.

![Tạo Target Group thành công](/aws-intern-report/images/5-Workshop/5.3-Network/alb-target-group-result.png)
...
![Chọn loại ALB](/aws-intern-report/images/5-Workshop/5.3-Network/create-alb.png)
![Cấu hình tên ALB](/aws-intern-report/images/5-Workshop/5.3-Network/create-alb-1.png)
...
![Ánh xạ mạng ALB](/aws-intern-report/images/5-Workshop/5.3-Network/create-alb-2.png)
...
![Cấu hình Listener](/aws-intern-report/images/5-Workshop/5.3-Network/create-alb-3.png)
