...
![Create Security Group for ALB](/aws-intern-report/images/5-Workshop/5.3-Network/alb-sg.png)
...
![Create Target Group Step 1](/aws-intern-report/images/5-Workshop/5.3-Network/alb-target-group-1.png)

8.  **Register targets:** Since we haven't deployed the ECS tasks yet, skip this step and click **Create target group**.

![Target Group Created](/aws-intern-report/images/5-Workshop/5.3-Network/alb-target-group-result.png)
...
![Select ALB Type](/aws-intern-report/images/5-Workshop/5.3-Network/create-alb.png)
![Configure ALB Basics](/aws-intern-report/images/5-Workshop/5.3-Network/create-alb-1.png)
...
![Network Mapping](/aws-intern-report/images/5-Workshop/5.3-Network/create-alb-2.png)
...
![Configure Listener](/aws-intern-report/images/5-Workshop/5.3-Network/create-alb-3.png)
