...
![Kiểm tra ECR trống](/aws-intern-report/images/5-Workshop/5.4-fe/ecr-check.png)
...
![Chọn thực thể tin cậy](/aws-intern-report/images/5-Workshop/5.4-fe/iam-ecr-create-1.png)

4.  **Use case:** Chọn **Elastic Container Registry - Replication** để cho phép ECR sao chép image.

![Chọn Use Case](/aws-intern-report/images/5-Workshop/5.4-fe/iam-ecr-create-3.png)
...
![Kiểm tra quyền hạn](/aws-intern-report/images/5-Workshop/5.4-fe/iam-ecr-create-4.png)

6.  **Name, review, and create:**
    -   Tên role được đặt tự động là `AWSServiceRoleForECRReplication`.
    -   Xem lại cấu hình và tạo role.

![Xem lại Role](/aws-intern-report/images/5-Workshop/5.4-fe/iam-ecr-create-5.png)

7.  **Kết quả:** Role đã được tạo thành công và xuất hiện trong danh sách IAM Roles.

![IAM Role đã tạo](/aws-intern-report/images/5-Workshop/5.4-fe/iam-ecr-create-2.png)
...
![Cấu hình Repository](/aws-intern-report/images/5-Workshop/5.4-fe/ecr-create-1.png)

4.  **Kết quả:** Repository `band-up-frontend` đã được tạo thành công với mã hóa mặc định AES-256.

![Repository đã tạo](/aws-intern-report/images/5-Workshop/5.4-fe/ecr-create-result.png)
...
![Tạo Access Key Bước 1](/aws-intern-report/images/5-Workshop/5.4-fe/get-key-for-cli-1.png)
![Chọn Use Case CLI](/aws-intern-report/images/5-Workshop/5.4-fe/get-key-for-cli-2.png)
![Lấy thông tin Key](/aws-intern-report/images/5-Workshop/5.4-fe/get-key-for-cli-4.png)
...
![Cấu hình AWS CLI](/aws-intern-report/images/5-Workshop/5.4-fe/cli-configure.png)
...
![Đăng nhập CLI thành công](/aws-intern-report/images/5-Workshop/5.4-fe/cli-login.png)
...
![Gán Tag cho Image](/aws-intern-report/images/5-Workshop/5.4-fe/tag-image.png)
...
![Quá trình Push Image](/aws-intern-report/images/5-Workshop/5.4-fe/push-to-ecr.png)
...
![Kiểm tra Image trên Console](/aws-intern-report/images/5-Workshop/5.4-fe/check-ecr.png)
