...
![Check Empty ECR](/aws-intern-report/images/5-Workshop/5.4-fe/ecr-check.png)
...
![Select Trusted Entity](/aws-intern-report/images/5-Workshop/5.4-fe/iam-ecr-create-1.png)

4.  **Use case:** Select **Elastic Container Registry - Replication** to allow ECR to replicate images.

![Select Use Case](/aws-intern-report/images/5-Workshop/5.4-fe/iam-ecr-create-3.png)
...
![Verify Permissions](/aws-intern-report/images/5-Workshop/5.4-fe/iam-ecr-create-4.png)
...
![Review Role](/aws-intern-report/images/5-Workshop/5.4-fe/iam-ecr-create-5.png)

7.  **Result:** The role is successfully created and listed in the IAM Roles dashboard.

![IAM Role Created](/aws-intern-report/images/5-Workshop/5.4-fe/iam-ecr-create-2.png)
...
![Create Repository Settings](/aws-intern-report/images/5-Workshop/5.4-fe/ecr-create-1.png)

4.  **Result:** The `band-up-frontend` repository is successfully created with AES-256 encryption enabled by default.

![Repository Created](/aws-intern-report/images/5-Workshop/5.4-fe/ecr-create-result.png)
...
![Create Access Key Step 1](/aws-intern-report/images/5-Workshop/5.4-fe/get-key-for-cli-1.png)
![Select CLI Use Case](/aws-intern-report/images/5-Workshop/5.4-fe/get-key-for-cli-2.png)
![Retrieve Access Keys](/aws-intern-report/images/5-Workshop/5.4-fe/get-key-for-cli-4.png)
...
![AWS CLI Configure](/aws-intern-report/images/5-Workshop/5.4-fe/cli-configure.png)
...
![CLI Login Success](/aws-intern-report/images/5-Workshop/5.4-fe/cli-login.png)
...
![Tag Docker Image](/aws-intern-report/images/5-Workshop/5.4-fe/tag-image.png)
...
![Push Image Process](/aws-intern-report/images/5-Workshop/5.4-fe/push-to-ecr.png)
...
![Verify Image in Console](/aws-intern-report/images/5-Workshop/5.4-fe/check-ecr.png)
