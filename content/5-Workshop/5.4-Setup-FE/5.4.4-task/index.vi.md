...
![Cấu hình Hạ tầng Task](/aws-intern-report/images/5-Workshop/5.4-fe/fe-task-1.png)
...
![Cấu hình Container](/aws-intern-report/images/5-Workshop/5.4-fe/fe-task-2.png)
...
![Tổng quan Cluster](/aws-intern-report/images/5-Workshop/5.4-fe/fe-cluster-1.png)
...
![Cấu hình Môi trường Service](/aws-intern-report/images/5-Workshop/5.4-fe/fe-service-1.png)
...
![Cấu hình Mạng Service](/aws-intern-report/images/5-Workshop/5.4-fe/fe-service-2.png)
...
![Chọn Load Balancer](/aws-intern-report/images/5-Workshop/5.4-fe/fe-service-3.png)

-   **Listener:** Chọn Create new listener tại Port `80` (HTTP).
-   **Target group:** Chọn Use an existing target group -> `target-bandup-fe`.

![Cấu hình Listener](/aws-intern-report/images/5-Workshop/5.4-fe/fe-service-5.png)
...
![Service đang chạy thành công](/aws-intern-report/images/5-Workshop/5.4-fe/fe-service-6.png)
...
![Truy cập qua ALB DNS](/aws-intern-report/images/5-Workshop/5.4-fe/check-fe-using-alb.png)
![Giao diện BandUp](/aws-intern-report/images/5-Workshop/5.4-fe/result.png)
