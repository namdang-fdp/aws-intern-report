...
![Task Definition Infrastructure](/aws-intern-report/images/5-Workshop/5.4-fe/fe-task-1.png)
...
![Container Configuration](/aws-intern-report/images/5-Workshop/5.4-fe/fe-task-2.png)
...
![Cluster Overview](/aws-intern-report/images/5-Workshop/5.4-fe/fe-cluster-1.png)
...
![Service Environment Config](/aws-intern-report/images/5-Workshop/5.4-fe/fe-service-1.png)
...
![Service Networking Config](/aws-intern-report/images/5-Workshop/5.4-fe/fe-service-2.png)
...
![Load Balancing Selection](/aws-intern-report/images/5-Workshop/5.4-fe/fe-service-3.png)

-   **Listener:** Create a new listener on Port `80` (HTTP).
-   **Target group:** Use an existing target group -> `target-bandup-fe`.

![Listener Configuration](/aws-intern-report/images/5-Workshop/5.4-fe/fe-service-5.png)
...
![Service Running Successfully](/aws-intern-report/images/5-Workshop/5.4-fe/fe-service-6.png)
...
![Access via ALB DNS](/aws-intern-report/images/5-Workshop/5.4-fe/check-fe-using-alb.png)
![BandUp Landing Page](/aws-intern-report/images/5-Workshop/5.4-fe/result.png)
